...
class Distance_calculator():
    ...
    def read_distance(self, data):
        ...
        # info = "\n"
        # info += f"front:{self.front_dis}\n"
        # info += f"right:{self.right_dis}\n"
        # info += f"behind:{self.behind_dis}\n"
        # info += f"left:{self.left_dis}\n"
        # rospy.loginfo(info)
    ...
    def get_distance(self, req):
        ...
        if direction_name == "front":
            ...
            rospy.logger(f"direction name is not valid: {direction_name}")
            return None
